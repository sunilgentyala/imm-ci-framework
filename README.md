...
pilot delta (all three dimensions improve, composite advances), sector profiles (energy L1,
healthcare L2, water L3 post-pilot, financial L4), cross-sector monotonic ordering, and
stall pattern detection across sectors.
